...
test('Price', async (t) => {
	await t.test('#constructor', async (t) => {
		...
		const xejpdpmvvg = new SKOSConcept({ connector, semanticId: 'http://base.com/najxckwhaf' });
		const obj = new Price({
			connector,
			value: 0.5815957,
			vatRate: 0.19110298,
